...
impl Default for SessionStopKind {
    fn default() -> Self {
...
pub(crate) struct ChatCommandContext {
    ...
    pub(crate) stop_kind: SessionStopKind,
}
...
impl ChatCommandContext {
    pub(crate) fn new(
        ...
        Self {
            ...
            active_agent,
            mcp_context: None,
            stop_kind: SessionStopKind::default(),
        }
    }
    ...
    fn unknown_command_message(&self) -> String {
        crate::t!("builtin.help").to_string()
    }
}
    ...
    pub(crate) async fn execute(
        ...
        match action {
            ...
            CommandAction::StopSession => {
                ...
                match &context.stop_kind {
                    SessionStopKind::Webui { agent_session_id } => {
                        GLOBAL_CHANNEL_SESSIONS
                            .stop_webui_session(&context.channel_id, agent_session_id)
                            .await?;
                    }
                    SessionStopKind::PlatformChannel => {
                        GLOBAL_CHANNEL_SESSIONS
...
async fn resume_or_fallback(
    ...
    if resume_session_id.is_none() {
        let sessions =
            GLOBAL_CHANNEL_SESSIONS.list_agent_sessions_by_channel(&context.channel_id, Some(1));
