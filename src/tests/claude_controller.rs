use crate::claude::controller::{ClaudeController, ControllerEvent, ensure_under_home};
...
async fn test_process_claude_event_emits_tool_result() {
    ...
    let session_arc: Arc<RwLock<Option<crate::claude::session::ClaudeSession>>> = Arc::new(RwLock::new(None));
